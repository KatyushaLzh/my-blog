...
export const siteConfig: SiteConfig = {
	...
	subtitle: "记录技术与成长",
	siteURL: "https://katyusha-blog.com/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2026-06-23", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	bilibili: {
		vmid: "1644609866", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
	...
	font: {
		...
		cjkFont: {
			...
			fontWeight: "400",
			localFonts: [],
			enableCompress: false, // 使用系统中文字体栈，不打包正文中文字体
		},
	},
